...
export const VILLAINS: IVillain[] = [
  ...
  {
    Id: 7,
    FullName: 'The WeirdShadow',
    FirstName: 'The',
    LastName: 'WeirdShadow',
    Description: 'Said to be able to create any shadow puppet imaginable, even ones from your deepest nightmares.',
    URI: 'theweirdshadow',
    ImageLocation: ''
  },
  {
    Id: 8,
    FullName: 'Dr. OppedMic',
    FirstName: 'Dr',
    LastName: 'OppedMic',
