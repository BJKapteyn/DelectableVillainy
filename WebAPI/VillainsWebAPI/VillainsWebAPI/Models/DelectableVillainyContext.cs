...
namespace VillainsWebAPI.Models
{
  public partial class DelectableVillainyContext : DbContext
  {
    ...
    public DelectableVillainyContext(DbContextOptions<DelectableVillainyContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
      if (!optionsBuilder.IsConfigured)
      {
        ...
        optionsBuilder.UseSqlServer(_configuration.GetConnectionString("VillainDBConnectionString"));
      }
    }
